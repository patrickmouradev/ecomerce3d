...
public class PricingCalculatorService {
    ...
    public PricingResult calculatePricing(Product product) {
        ...
        BigDecimal filamentPrice = BigDecimal.ZERO;
        if (product.getFilament() != null && product.getFilament().getPricePerKg() != null) {
            filamentPrice = product.getFilament().getPricePerKg();
        }

        BigDecimal weight = product.getWeightG() != null ? product.getWeightG() : BigDecimal.ZERO;
        ...
        // filament_cost = (filament_price / 1000) * weight
        BigDecimal filamentCost = filamentPrice
